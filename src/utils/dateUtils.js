import { addWeeks, compareAsc, compareDesc, differenceInCalendarDays, format, formatRelative, getDay, isDate, isExists, isPast, isThisWeek, isToday, parseJSON } from "date-fns";
 ...
 * @returns {Boolean}
 */
export const isFutureDate = date => isDate(date) && isPast(date);
